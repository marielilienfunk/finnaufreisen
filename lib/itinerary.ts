    ...
    days: [
      {
        ...
        summary: "Anreise nach Lanzarote, locker eingewöhnen und der erste Sonnenuntergang am Meer.",
        activities: [
          {
            id: uid(),
            time: "11:00",
            ...
            description: "Landung in Arrecife, Mietwagen abholen und Richtung Unterkunft.",
          ...
          },
          {
            ...
            time: "14:00",
            type: "restaurant",
            title: "Mittagessen in Arrecife",
            description: "Frischer Fisch und Papas arrugadas direkt an der Strandpromenade.",
            location: "Charco de San Ginés, Arrecife, Lanzarote, Spain",
          },
          {
            id: uid(),
            time: "17:00",
            type: "sightseeing",
            title: "Spaziergang Playa del Reducto",
            description: "Erstes Eintauchen ins Meer und Beine vom Flug lockern.",
            location: "Playa del Reducto, Arrecife, Lanzarote, Spain",
          },
          {
            id: uid(),
            time: "20:00",
            type: "dinner",
            title: "Abendessen mit Sonnenuntergang",
            description: "Kanarische Küche bei Sonnenuntergang am Hafen.",
            location: "Restaurante Lilium, Arrecife, Lanzarote, Spain",
          },
        ],
      },
      {
