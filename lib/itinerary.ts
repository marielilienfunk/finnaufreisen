  ...
  return {
    ...
    days: [
      ...
      },
      {
        ...
        summary: "Morgens letzter Strandspaziergang, dann Fähre von Playa Blanca nach Corralejo. Unterkunft beziehen und ersten Abend in Corralejo erkunden.",
        activities: [
          {
            id: uid(),
            time: "09:00",
            type: "activity",
            title: "Letzter Morgen: Papagayo-Strand",
            description: "Letztes Bad an den Papagayo-Buchten vor der Überfahrt.",
            location: "Playas de Papagayo, Lanzarote, Spain",
            mapQuery: "Playas de Papagayo Lanzarote",
          },
          {
            ...
            description: "Ca. 30 Minuten Überfahrt nach Fuerteventura. Uhrzeit folgt.",
          ...
          },
          {
            ...
            description: "Einchecken und durch den Hafenort bummeln.",
